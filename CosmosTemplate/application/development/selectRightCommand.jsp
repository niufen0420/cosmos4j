...
<form style="padding: 0;" action="../dev/selectRightCommand?forward=common.parent_refresh" method="post" enctype="application/x-www-form-urlencoded">
...
<div id="listContent">
    ...
    <div id="top" class="toolBar">
        <div class="left" style="width: 100%;">
			<pager:info totalItems="${fn:length(commands)}" url="commands?leftDomain=${param.leftDomain}&leftCommand=${param.leftCommand}&composite=${param.composite}&forward=development.selectRightCommand" numPerPage="20" currentPageNum="${param.page}" pageNumShown="5" >

...
/**
 * <p>
 * <code>Double</code>类型转换器，将字符串型转换为<code>Double</code>。
 * </p>
 * 
 ...
 * @since CFDK 1.0
 */
public class DoubleConverter extends AbstractCosmosArgumentConverter {
	 ...
	 *            类型转换器的名称。
	 */
	public DoubleConverter(String label, String name) {
		super(label, name);
	}

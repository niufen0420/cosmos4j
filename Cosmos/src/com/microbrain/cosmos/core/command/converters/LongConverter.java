...
/**
 * <p>
 * <code>Long</code>类型转换器，将字符串型转换为<code>Long</code>。
 * </p>
 * 
 ...
 * @since CFDK 1.0
 */
public class LongConverter extends AbstractCosmosArgumentConverter {
	 ...
	 *            类型转换器的名称。
	 */
	public LongConverter(String label, String name) {
		super(label, name);
	}
	...
	public Object convert(String value) {
		Long rlt = Long.valueOf(0);
		if ((value != null) && !value.equals("")) {
			rlt = Long.valueOf(value);
		}
		return rlt;
	}

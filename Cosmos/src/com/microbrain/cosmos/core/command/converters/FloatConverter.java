...
/**
 * <p>
 * <code>Float</code>类型转换器，将字符串型转换为<code>Float</code>。
 * </p>
 * 
 ...
 * @since CFDK 1.0
 */
public class FloatConverter extends AbstractCosmosArgumentConverter {
	 ...
	 *            类型转换器的名称。
	 */
	public FloatConverter(String label, String name) {
		super(label, name);
	}
	...
	public Object convert(String value) {
		Float rlt = Float.valueOf(0);
		if ((value != null) && !value.equals("")) {
			rlt = Float.valueOf(value);
		}
		return rlt;
	}

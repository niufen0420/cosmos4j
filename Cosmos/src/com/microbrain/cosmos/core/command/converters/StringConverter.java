...
/**
 * <p>
 * <code>String</code>类型转换器，将字符串型转换为<code>String</code>。
 * </p>
 * 
 ...
 * @since CFDK 1.0
 */
public class StringConverter extends AbstractCosmosArgumentConverter {
	 ...
	 *            类型转换器的名称。
	 */
	public StringConverter(String label, String name) {
		super(label, name);
	}

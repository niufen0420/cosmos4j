...
/**
 * <p>
 * <code>Time</code>类型转换器，将字符串型转换为<code>Time</code>。
 * </p>
 * 
 ...
 * @since CFDK 1.0
 */
public class TimeConverter extends AbstractCosmosArgumentConverter {
	 ...
	 *            类型转换器的名称。
	 */
	public TimeConverter(String label, String name) {
		super(label, name);
	}
	...
	public Object convert(String value) {
		Time rlt = null;
		try {
			rlt = Time.valueOf(value);
		} catch (IllegalArgumentException e) {
			e.printStackTrace();
			throw new IllegalArgumentException("Bad time format of '" + value
					+ "',should be 'hh:mm:ss'");
		}
		return rlt;
	}

...
import com.microbrain.cosmos.core.domain.db.AbstractCosmosJndiDomain;
 ...
 * @since CFDK 1.0
 */
public class CosmosMysqlJndiDomain extends AbstractCosmosJndiDomain {
	 ...
	 *            域序号。
	 */
	public CosmosMysqlJndiDomain(String name, CosmosDomainType type, int index) {

...
/**
 * <p>
 * <code>BigDecimal</code>类型转换器，将字符串型转换为<code>BigDecimal</code>。
 * </p>
 * 
 ...
 * @since CFDK 1.0
 */
public class BigDecimalConverter extends AbstractCosmosArgumentConverter {
	 ...
	 *            类型转换器的名称。
	 */
	public BigDecimalConverter(String label, String name) {
		super(label, name);
	}

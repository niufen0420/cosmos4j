...
/**
 * <p>
 * <code>ByteArray</code>类型转换器，将字符串型转换为<code>ByteArray</code>。
 * </p>
 * 
 ...
 */
public class ByteArrayConverter extends AbstractCosmosArgumentConverter {
	 ...
	 *            类型转换器的名称。
	 */
	public ByteArrayConverter(String label, String name) {
		super(label, name);
	}

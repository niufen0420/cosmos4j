...
<form style="padding: 0;" action="../dev/selectSubCommand?forward=common.parent_refresh" method="post" enctype="application/x-www-form-urlencoded">
<input type="hidden" name="parentDomain" value="${param.parentDomain}" />
<input type="hidden" name="parentCommand" value="${param.parentCommand}" />
<input type="hidden" name="composite" value="${param.composite}" />
<div id="listContent">
    <h1><span>全局命令列表</span></h1>
    <div id="top" class="toolBar">
        <div class="left" style="width: 100%;">
			<pager:info totalItems="${fn:length(commands)}" url="commands?parentDomain=${param.parentDomain}&parentCommand=${param.parentCommand}&composite=${param.composite}&forward=development.selectSubCommand" numPerPage="20" currentPageNum="${param.page}" pageNumShown="5" >

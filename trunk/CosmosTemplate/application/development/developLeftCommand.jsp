...
<body>
<form class="detail" action="../dev/createLeftCommand?forward=common.parent_refresh" method="post" enctype="application/x-www-form-urlencoded">
  ...
  <div class="toolBar">
  	<div class="left">
	  <input class="ButSub" onclick="document.location='../dev/commands?rightDomain=${param.rightDomain}&rightCommand=${param.rightCommand}&composite=${param.composite}&forward=development.selectLeftCommand';" type="button" name="Load" value="已有命令" />
  	</div>
  	<div class="right">

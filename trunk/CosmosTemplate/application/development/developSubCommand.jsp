...
<body>
<form class="detail" action="../dev/createSubCommand?forward=common.parent_refresh" method="post" enctype="application/x-www-form-urlencoded">
  ...
  <div class="toolBar">
  	<div class="left">
	  <input class="ButSub" onclick="document.location='../dev/commands?parentDomain=${param.parentDomain}&parentCommand=${param.parentCommand}&composite=${param.composite}&forward=development.selectSubCommand';" type="button" name="Load" value="已有命令" />
  	</div>
  	<div class="right">
